...
function LoginPage() {
  ...
  return (
    <div className='flex h-[100vh]  w-full items-center justify-center bg-green-200'>
      <section className='h-[min-content] justify-center rounded-lg bg-white p-1 font-secondary min-[320px]:h-auto min-[320px]:w-[420px] xl:h-[70vh] xl:w-[40vh] xl:rounded-lg'>
                  ...
                  dark:focus:border-black dark:focus:ring-black'
                    ...
                    <div className='mb-6'>
                      ...
                      <input
                        type='password'
                        id='password'
                        className='block w-full rounded-lg border border-gray-300 bg-green-300
                p-2.5 text-sm text-gray-900 focus:border-black dark:border-gray-600 dark:bg-green-300 dark:text-black dark:placeholder-gray-400 dark:focus:border-black
                  dark:focus:ring-black'
                    ...
                    <div className='justify-center text-center'>
                      <Link
                        ...
                        id='remember'
                        className='rounded-full bg-green-400 p-4 text-[20px] text-sm font-medium text-black underline decoration-black hover:file:underline dark:text-black'
                      >
                        No tengo cuenta
                      </Link>
                    </div>
